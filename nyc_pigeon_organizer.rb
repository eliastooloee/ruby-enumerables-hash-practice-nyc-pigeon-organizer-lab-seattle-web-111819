def nyc_pigeon_organizer(data)
  ...
  #We then use .to_s to set newval to a string and add it to the hash for the pigeon. There is nothing specific to any data set in this method, so it should work for     
